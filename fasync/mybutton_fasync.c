...
static int s3c24xx_buttons_read(struct file *file, char __user *buff, 
...
static int s3c24xx_buttons_fasync(int fd, struct file *file, int mode)
{
	return fasync_helper(fd, file, mode, &button_fasync);
}
